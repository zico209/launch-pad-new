...
import { useAccount, useWatchAsset, useAccountEffect } from "wagmi";
import styles from "./HomeBanner.module.scss";
import { IconC2n } from "@/components/icons";
import { useWriteAirdropWithdrawTokens, airdropAbi } from "@/abis/generated";
  ...
  const handleClaim = async () => {
    try {
      ...
      const res = await writeContractAsync({
        address: getWagmiAddress(appConfig.airDrop.address!),
        args: [],
      });
      console.log(res);
    } catch (error: any) {
